...
const CreatorsPlatform = () => {
    ...
    return (
        <div
            className="lg:justify-between content-wrapper h-full w-full flex flex-col lg:flex-row lg:mx-auto lg:px-0 lg:px-[15px] px-[5px] 3xl:max-w-[1670px] 2xl:max-w-[1400px] xl:max-w-[1200px] md:max-w-[900px]"
        >
            <div
            ...
            <div
                className="cp-right-block lg:w-1/2 w-full flex justify-center lg:mt-0 md:mt-[42px] mt-[12px] max-w-[819px] items-start" 
                >
                <div className="relative w-full 3xl:max-w-[747px] lg:max-w-[620px] 3xl:aspect-[747/728] xl:aspect-[620/550] aspect-[348/340] max-w-[348px] 3xl:max-h-[728px] xl:max-h-[550px] max-h-[340px] lg:h-auto corners z-15">
                    <div className="relative w-full h-full">
                        ...
                        >
                            ...
                            />
                            <div
                                className="absolute overflow-hidden z-20 rounded-[40px] h-[304px] xl:w-[215px] 3xl:h-[651px] xl:h-[450px] mobile-frame absolute z-30 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none h-[300px] w-[150px]"
                            >
                                <video
                                src={getImagePath("/images/CreatorsPlatform/cp-video.webm")}
                                autoPlay
